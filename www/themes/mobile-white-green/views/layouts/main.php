...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" xml:lang="en" lang="en"> 
  ...
  <body class="home blog"> 
    <div id="wrapper"> 
      ...
      <div id="navigation"> 
        <a title="Меню" id="navigate" class="button normal"> 
          <span class="before"></span> 
          Меню <img src="<?php echo Yii::app()->theme->baseUrl ?>/images/down.png" alt="" /> 
    ...
    <div id="menu">
        <?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				array('label'=>'Друзья', 'url'=>array('/site/index'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'Я', 'url'=>array('/site/myactivity'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=> Yii::app()->user->role=='admin' ? 'Панель управления' : 'Профиль', 'url'=>array('/controlPanel'), 'visible'=>!Yii::app()->user->isGuest),
